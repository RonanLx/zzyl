...
public class RoomController extends BaseController
{
    ...
    @GetMapping("/one/{id}")
    public R<RoomVo> getRoomById(@PathVariable Long id){
        return R.ok(roomService.getRoomById(id));
    }

    @GetMapping("/getRoomsWithDeviceByFloorId/{floorId}")
    public AjaxResult getRoomsWithDeviceByFloorId(@PathVariable("floorId") Long floorId){
